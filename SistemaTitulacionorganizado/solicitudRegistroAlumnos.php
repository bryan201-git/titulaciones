...
if(isset($_POST["btnEnviar"])){
  ...
  if ($result = $db->query($sqlComprueba)) {
    if ($result->num_rows == 1) {
      ...
      $sqlRegistro = "INSERT INTO alumnos (noncontrol,nombre,apellidopaterno,apellidomaterno,telefono,correo,password,plan,status)
        VALUES ('$noncontrol','$nombre','$apellidopaterno','$apellidomaterno','$telefono','$correo','$contrasena','$plan',0);";
...
<div class="container">
  <div class="row">
    ...
    <div class="col">
      <form action="solicitudRegistroAlumnos.php" method="post">
        <br><br>
       ...
       <div class="form-group">
         ...
         <input type="password" class="form-control" id="contrasena" name="contrasena" minlength="8"maxlength="32"
